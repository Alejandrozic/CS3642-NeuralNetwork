...
from neutral_network.neutral_network import ANN
from neutral_network.create_combinations import create_combinations
from neutral_network.constants import WHITE_INT, BLACK_INT
...
class NeuralNetworkApp(tk.Canvas):
    ...
    def __init__(self):
        ...
        # -- Initialize NN -- #
        self.update_nn(self.neutral_network.to_dict())
    ...
    def init_options_frame(self):
        ...
        new_btn = tk.Button(options_frame, text="RESET Neutral Network", command=self.reset_nn, bg="cornsilk3")
        new_btn.pack(side='top')

        new_btn = tk.Button(options_frame, text="Train Neutral Network", command=self.train_nn, bg="cornsilk3")
        new_btn.pack(side='top')

        reset_btn = tk.Button(options_frame, text="Test Neutral Network", command=self.test_nn, bg="cornsilk3")
    ...
    def train_nn(self):
        ...
        while all_success is False:
            ...
            for i in training_set:
                ...
                _bool = self.neutral_network.train(*i, expected_answer=expected_answer)
                result[i] = _bool
    ...
    def test_nn(self):
        ...
        for i in test_set:
            ...
            self.__waiting__(3)
            answer = self.neutral_network.test(*i)
            expected_answer = WHITE_INT if i.count(WHITE_INT) >= 2 else BLACK_INT
